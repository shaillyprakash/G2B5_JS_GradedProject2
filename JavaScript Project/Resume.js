...
const controller = function(){
    ...
    const header = function(value){
        ...
        var code =
            ...
            </div><i class="fas fa-user" style="font-size: 100px; margin-right: 10%"></i></>
    ...
    const sidebar = function(value){
        ...
        value.interest.hobbies.map((item)=>{hobbies+='<li>${item}</li>'})
        ...
        <article class="objective1">
            ...
            <ul class ="detailsList">
                ...
                <li><a href=${value.basics.profiles.url} traget="blank">LinkedIn</a></li>
            </ul>
        </article>
    ...
    const mainPage= function(value){
        ...
        document.getElementById('leftPage').innerHTML = ele
    }
    ...
    const education = function(value) {
        ...
        vals.map((item,ind)=>{
            ...
            console.log(names)
            ele+= `<li><b>${eds[ind]}:</b>`
            names.maps((element)=>{ele+=`${element},`})
    ...
    const internship = function(value){
        ...
        const achievement = function(value){
            var ele=``;
